...
const translationFiles: Record<string, Record<string, any>> = {
  'zh-CN': {
    ...
    Home: zhCNHome,
    IngredientInput: zhCNIngredientInput,
    CommentList: zhCNCommentList,
    CommentForm: zhCNCommentForm,
    RecipeDetail: zhCNRecipeDetail,
    Recipes: zhCNRecipes,
    Login: zhCNLogin,
    LoginForm: zhCNLoginForm,
    Header: zhCNHeader,
    Footer: zhCNFooter,
    OAuth: zhCNOAuth,
  ...
  'en': {
    ...
    Metadata: enMetadata,
    Home: enHome,
    IngredientInput: enIngredientInput,
    CommentList: enCommentList,
    CommentForm: enCommentForm,
    RecipeDetail: enRecipeDetail,
    Recipes: enRecipes,
    Login: enLogin,
